...
from app_1.views import (views, show_chart, crawl_comment, upload, emotion_chart, emotion_sdk, lstm,
                         crawl_price, trans,summary)
...
urlpatterns = [
    ...
    path('crawl/file', crawl_comment.crawl_file),
